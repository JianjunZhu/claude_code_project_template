...
> 本文件仅在当前项目确属"补全/重建"任务时启用；启用方式为在 `docs/records/PROJECT.md` 标注任务类型并按需引用本文件。所有具体取值用占位符表达，未知=TBD、未验证=PENDING、未确认=NOT VERIFIED、未完成=INCOMPLETE。
...
1. `docs/records/PROJECT.md`、2. `docs/records/TASK_BRIEF.md`、3. `docs/rules/RESEARCH_RULES.md`、4. `docs/records/EVIDENCE.md` 与 `docs/records/EXPERIMENT_LOG.md`、5. `data/README.md`（含降质/缺失约定）、6. `CLAUDE.md`。
